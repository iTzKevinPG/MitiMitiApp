...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between rounded-[var(--radius-md)] border px-3 py-2 text-sm transition-all",
      ...
      "focus:outline-none focus:ring-2 focus:ring-[color:var(--color-focus-ring)] focus:ring-offset-2",
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "focus:bg-[color:var(--color-surface-muted)] focus:text-[color:var(--color-text-main)]",
      className
    )}
    {...props}
  >
